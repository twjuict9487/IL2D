def build_tutorial_steps(_lang="zh"):
    ...
    return [
        ...
        {"id": "npc_intro", "title_key": "tutorial.dev.step.4.title", "hint_key": "tutorial.dev.step.4.hint"},
        {"id": "esc_open", "title_key": "tutorial.dev.step.5.title", "hint_key": "tutorial.dev.step.5.hint"},
        {"id": "esc_close", "title_key": "tutorial.dev.step.6.title", "hint_key": "tutorial.dev.step.6.hint"},
        {"id": "finish_reset", "title_key": "tutorial.dev.step.7.title", "hint_key": "tutorial.dev.step.7.hint"},
    ]
